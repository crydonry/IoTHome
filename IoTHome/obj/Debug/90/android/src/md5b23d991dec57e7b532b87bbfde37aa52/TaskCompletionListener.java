package md5b23d991dec57e7b532b87bbfde37aa52;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IoTHome.EventListeners.TaskCompletionListener, IoTHome", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("IoTHome.EventListeners.TaskCompletionListener, IoTHome", "", this, new java.lang.Object[] {  });
	}
